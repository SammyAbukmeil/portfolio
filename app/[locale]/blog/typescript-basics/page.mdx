...
<TableOfContents
  items={[
    { text: "What is TypeScript", link: "#what-is-typescript", nested: false },
    {
      text: "Setup a Local Environment",
      link: "#setup-a-local-environment",
      nested: false,
    },
    { text: "Vanilla TypeScript", link: "#vanilla-typescript", nested: false },
    { text: "Typing Arrays", link: "#typing-arrays", nested: true },
    { text: "Tuples", link: "#tuples", nested: true },
    { text: "Typing Objects", link: "#typing-objects", nested: true },
    { text: "Enums", link: "#enums", nested: true },
    { text: "Type Aliases", link: "#type-aliases", nested: true },
    { text: "Interfaces", link: "#interfaces", nested: true },
    { text: "Union Types", link: "#union-types", nested: true },
    { text: "Typing Functions", link: "#typing-functions", nested: true },
    { text: "Typing Classes", link: "#typing-classes", nested: true },
    { text: "Generic Functions", link: "#generic-functions", nested: true },
    { text: "Generic Type Aliases", link: "#generic-type-aliases", nested: true },
    { text: "TypeScript With React", link: "#typescript-with-react", nested: false },
    { text: "Typing Props", link: "#typing-props", nested: true },
    { text: "Typing State", link: "#typing-state", nested: true },
    { text: "TypeScript With Express", link: "#typescript-with-express", nested: false },
    { text: "Typing Core Express Objects", link: "#typing-core-express-objects", nested: true },
  ]}
/>
...
That's it for this article! There's a lot more to TypeScript, TypeScript in React, and TypeScript in Express than what we've covered here.
Check these links for more:

- [TypeScript Documentation](https://www.typescriptlang.org/docs)
- [React's TypeScript guide](https://react.dev/learn/typescript)
- [Node.js TypeScript introduction](https://nodejs.org/en/learn/typescript/introduction)
- [Express with TypeScript tutorial](https://blog.logrocket.com/express-typescript-node)
